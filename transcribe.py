#!/usr/bin/env python3
"""
CML Transcriptie Tool - WhisperX CLI Transcription for macOS Apple Silicon
"""
...
# Real-time factors for CPU int8 on Apple Silicon (time to process / audio duration)
RTF_MAP = {
    'tiny': 0.3,
    'base': 0.5,
    'small': 0.8,
...
def run_transcription(audio_path, model_size, language):
    ...
    try:
        ...
        # Alignment kan falen voor sommige talen - gebruik dan ruwe segmenten
        sys.stdout = old_stdout
